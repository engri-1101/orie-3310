...
def plot_taxi_route(G, paths, nodes_df, title = 'Taxi Routes'):
    ...
    graph2.node_renderer.glyph = Circle(radius=7,line_width=1,fill_alpha=1, fill_color='pu_colors', line_color='black')
...
def plot_bipartite_graph2(B, match, paths, G, nodes_df, title = 'Taxi Routes'):
    ...
    graph.node_renderer.glyph = Circle(radiue=7,line_width=1,fill_alpha=1, fill_color='pu_colors', line_color='black')
...
def plot_pairwise_incompatible(B, match, paths, G, nodes_df, incomp_trips, title = 'Taxi Routes'):
    ...
    # define pickup location nodes
    graph.node_renderer.data_source.add(pus, 'index')
    graph.node_renderer.glyph = Circle(radius=7,line_width=1,fill_alpha=1, fill_color='blue', line_color='black')
...
def plot_bipartite_route(G, paths, nodes_df, title = 'Taxi Routes'):
    ...
    graph.node_renderer.glyph = Circle(radius=8,line_width=1,fill_alpha=1, fill_color='pu_colors', line_color='black')
